...
from qfluentwidgets import (ScrollArea, PushButton, ToolButton, FluentIcon,
                            ...
                            StrongBodyLabel, BodyLabel, toggleTheme, PrimaryPushButton)
...
class ExampleCardClear(QWidget):
    """ Example card """
...
class GalleryInterface(ScrollArea):
    ...
    def addExampleCard(self, title, widget, stretch=0, alignment=Qt.AlignHCenter):
        card = ExampleCardClear(title, widget, stretch, self.view)
        # self.vBoxLayout.addWidget(card, 0, Qt.AlignTop)
        # update
        self.vBoxLayout.addWidget(card, 0, alignment)
        return card

    def removeExampleCard(self, title, widget, stretch=0):
        card = ExampleCardClear(title, widget, stretch, self.view)
        # update
