...
from PyQt5.QtWidgets import QWidget, QHBoxLayout, QLabel, QSizePolicy, QFileDialog
from qfluentwidgets import ToolButton, ExpandSettingCard, ConfigItem, PushButton, qconfig, Dialog, FluentIcon
...
class FolderSettingCard(ExpandSettingCard):
...
class FileSettingCard(ExpandSettingCard):
    """ Folder list setting card """
    ...
    def __showFolderDialog(self):
        ...
        options = QFileDialog.Options()
        options |= QFileDialog.DontUseNativeDialog
        folder, _ = QFileDialog.getOpenFileName(self, "选择文件", "", options=options)
