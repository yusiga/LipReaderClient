...
class BasicInputInterface(GalleryInterface):
    ...
    def __init__(self, parent=None):
        ...
        super().__init__(
            title=translator.basicInput, subtitle="qfluentwidgets.components.widgets", parent=parent
        )
        ...
        self.addExampleCard(
            ...
            HyperlinkButton("https://qfluentwidgets.com", "GitHub", self, FluentIcon.LINK),
            "https://github.com/zhiyiYo/PyQt-Fluent-Widgets/blob/master/examples/basic_input/button/demo.py",
        )
    ...
    def createStandMenu(self, button):
        ...
        menu.addActions(
            [
                Action(
                    self.tr("Star Platinum"),
                    triggered=lambda c, b=button: b.setText(self.tr("Star Platinum")),
                ),
                Action(
                    self.tr("Crazy Diamond"),
                    triggered=lambda c, b=button: b.setText(self.tr("Crazy Diamond")),
                ),
                Action(
                    self.tr("Gold Experience"),
                    triggered=lambda c, b=button: b.setText(self.tr("Gold Experience")),
                ),
                Action(
                    self.tr("Sticky Fingers"),
                    triggered=lambda c, b=button: b.setText(self.tr("Sticky Fingers")),
                ),
            ]
        )
        return menu
