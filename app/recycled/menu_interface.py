...
class MenuInterface(GalleryInterface):
    ...
    def __init__(self, parent=None):
        ...
        self.button3.clicked.connect(
            lambda: self.createCustomWidgetMenu(
        ...
        self.button2.clicked.connect(
            lambda: self.createCheckableMenu(
    ...
    def createMenu(self, pos):
        ...
        menu.insertActions(
            menu.actions()[-1],
            [Action(FIF.HELP, self.tr("Help")), Action(FIF.FEEDBACK, self.tr("Feedback"))],
        )
    ...
    def createCustomWidgetMenu(self, pos):
        ...
        # add custom widget
        card = ProfileCard(
            ":/gallery/images/shoko.png", self.tr("Shoko"), "shokokawaii@outlook.com", menu
        )
    ...
    def createCheckableMenu(self, pos=None):
        ...
        menu.addActions(
            [self.createTimeAction, self.shootTimeAction, self.modifiedTimeAction, self.nameAction]
        )
        menu.addSeparator()
